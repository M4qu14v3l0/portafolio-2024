...
const projects = [
    {id:1, title: 'mentorito', src: '/projects/mentorito.png', color: '#404040', description: 'It is a course recommendation system powered by artificial intelligence and machine learning. The user experience is personalized and promises to attract many students to TECSUP.'},
    ...
    {id:5 , title: 'roberts dercocenter', src: '/projects/roberts_derco.png', color: '#003366', description: 'Created a landing page for Roberts Dercocenter, providing access to all their vehicle offerings to clients. Additionally, it enables real-time connection between customers and sales agents at Roberts.'},
